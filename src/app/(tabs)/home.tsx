      ...
      <View className="z-20 border-b border-ink-100 bg-white px-5 pb-3 pt-3">
        <View className="flex-row items-center gap-3">
          ...
          <View className="flex-1 min-w-0">
            <Text numberOfLines={1} className="text-[12.5px] text-ink-500">
            ...
            >
              ...
              <Text numberOfLines={1} className="max-w-[170px] text-[13.5px] font-semibold text-ink">
                {currentLocation}
              </Text>
      ...
      >
        ...
        <View className="px-5 mt-3">
          ...
          >
            ...
            <Text className="text-[14.5px] text-ink-400">
        ...
        {mode === 'requester' ? (
          <View className="mx-5 mt-4 overflow-hidden rounded-4xl bg-brand-deep p-5">
            <Text className="text-[24px] font-bold leading-tight tracking-tight text-white">
          ...
          >
            {categories.slice(0, 8).map((category) => (
              ...
              >
                ...
                <Text
                  numberOfLines={1}
                  className="w-full text-center text-[11.5px] font-medium text-ink-700"
                >
                  {category.name}
                </Text>
              </Pressable>
            ...
            <View className="mt-7">
              <View className="px-5">
                ...
                {recommended.length > 0 && (
                  <Text className="-mt-1 mb-3 text-[12px] text-ink-400">
              ...
              {loading ? (
                ...
                <View className="mx-5 rounded-3xl border border-ink-200/70 bg-white p-4">
                  <Text className="text-[13px] leading-relaxed text-ink-500">
